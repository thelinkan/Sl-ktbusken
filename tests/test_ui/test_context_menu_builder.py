...
class TestContextMenuBuilder:
    ...
    def test_menu_has_seven_actions(
        ...
        """The menu should contain exactly 7 actions."""
    ...
    def test_actions_have_data_with_person_id(
        ...
        """Each action should carry data containing the person_id."""
        person_id = "person_42"
    ...
    def test_action_data_types(
        ...
        """Each action should carry a tuple of (action_type, person_id)."""
        menu = builder.build_person_menu("person_1", "main_1", parent_widget)
        actions = menu.actions()
        ...
        actual_types = [action.data()[0] for action in actions]
