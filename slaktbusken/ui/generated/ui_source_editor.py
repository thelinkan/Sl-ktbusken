...
class Ui_SourceEditor(object):
    def setupUi(self, SourceEditor):
        ...
        # Splitter: left panel (source list) + right panel (edit form)
        ...
        self.free_note_input.setMaximumHeight(80)
        ...
        # Structured reference group (dynamic fields)
        ...
        self.repository_list.setMaximumHeight(80)
        ...
        self.repository_buttons_spacer = QSpacerItem(0, 0, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
        self.repository_buttons_layout.addItem(self.repository_buttons_spacer)
    ...
    def retranslateUi(self, SourceEditor):
        ...
        self.provider_input.setPlaceholderText(QCoreApplication.translate("SourceEditor", u"t.ex. Arkiv Digital, Riksarkivet", None))
        ...
        self.title_input.setPlaceholderText(QCoreApplication.translate("SourceEditor", u"K\u00e4llans titel", None))
        self.ref_text_label.setText(QCoreApplication.translate("SourceEditor", u"Referenstext:", None))
        self.reference_text_input.setPlaceholderText(QCoreApplication.translate("SourceEditor", u"Fullst\u00e4ndig referens", None))
        self.provider_ref_label.setText(QCoreApplication.translate("SourceEditor", u"Leverant\u00f6rsref:", None))
        self.provider_ref_input.setPlaceholderText(QCoreApplication.translate("SourceEditor", u"Referens hos leverant\u00f6ren", None))
        self.short_note_label.setText(QCoreApplication.translate("SourceEditor", u"Kort notering:", None))
        self.short_note_input.setPlaceholderText(QCoreApplication.translate("SourceEditor", u"Kort notering", None))
        ...
        self.series_input.setPlaceholderText(QCoreApplication.translate("SourceEditor", u"t.ex. AI, CI, FI", None))
        ...
        self.years_input.setPlaceholderText(QCoreApplication.translate("SourceEditor", u"t.ex. 1800-1815", None))
