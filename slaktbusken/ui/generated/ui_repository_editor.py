...
class Ui_RepositoryEditor(object):
    def setupUi(self, RepositoryEditor):
        ...
        self.form_layout.setWidget(0, QFormLayout.ItemRole.LabelRole, self.name_label)

        self.name_input = QLineEdit(self.right_panel)
        self.name_input.setObjectName(u"name_input")

        self.form_layout.setWidget(0, QFormLayout.ItemRole.FieldRole, self.name_input)

        self.type_label = QLabel(self.right_panel)
        self.type_label.setObjectName(u"type_label")

        self.form_layout.setWidget(1, QFormLayout.ItemRole.LabelRole, self.type_label)
        ...
        self.form_layout.setWidget(1, QFormLayout.ItemRole.FieldRole, self.type_combo)

        self.address_label = QLabel(self.right_panel)
        self.address_label.setObjectName(u"address_label")

        self.form_layout.setWidget(2, QFormLayout.ItemRole.LabelRole, self.address_label)

        self.address_input = QLineEdit(self.right_panel)
        self.address_input.setObjectName(u"address_input")

        self.form_layout.setWidget(2, QFormLayout.ItemRole.FieldRole, self.address_input)
        ...
        self.phone_list.setMaximumSize(QSize(16777215, 80))
        ...
        self.email_list.setMaximumSize(QSize(16777215, 80))
        ...
        self.web_list.setMaximumSize(QSize(16777215, 80))
        ...
        self.external_ids_list.setMaximumSize(QSize(16777215, 80))
    ...
    def retranslateUi(self, RepositoryEditor):
        ...
        self.type_combo.setItemText(0, QCoreApplication.translate("RepositoryEditor", u"Arkiv", None))
        self.type_combo.setItemText(1, QCoreApplication.translate("RepositoryEditor", u"Bibliotek", None))
        self.type_combo.setItemText(2, QCoreApplication.translate("RepositoryEditor", u"Digitalt arkiv", None))
        self.type_combo.setItemText(3, QCoreApplication.translate("RepositoryEditor", u"Museum", None))
        self.type_combo.setItemText(4, QCoreApplication.translate("RepositoryEditor", u"Kyrkokontor", None))
        self.type_combo.setItemText(5, QCoreApplication.translate("RepositoryEditor", u"\u00d6vrigt", None))
