...
class Ui_PlaceEditor(object):
    def setupUi(self, PlaceEditor):
        ...
        # Splitter: left list panel | right edit panel
        ...
        self.latitude_spin.setMinimum(-90.0)
        self.latitude_spin.setMaximum(90.0)
        ...
        self.longitude_spin.setMinimum(-180.0)
        self.longitude_spin.setMaximum(180.0)
        ...
        # Set splitter sizes (left smaller, right larger)
