...
- [x] 1. Implement core deletion logic and analysis functions
  - [x] 1.1 Create the DeleteService module with DeletionConsequences dataclass and event classification
  ...
  - [x] 1.2 Write property test for event classification (Property 7)
  ...
  - [x] 1.3 Implement tree connectivity checker
  ...
  - [x] 1.4 Write property test for tree disconnection detection (Property 8)
...
- [x] 2. Implement deletion executor
  - [x] 2.1 Implement `execute_person_deletion(person_id, data)` function
  ...
  - [x] 2.2 Write property test for no dangling references (Property 1)
  ...
  - [x] 2.3 Write property test for media integrity (Property 2)
  ...
  - [x] 2.4 Write property test for no empty families (Property 3)
  ...
  - [x] 2.5 Write property test for events from removed families (Property 4)
  ...
  - [x] 2.6 Write property test for deleted person removal (Property 10)
...
- [x] 4. Implement DeleteService class and main person guard
  - [x] 4.1 Implement the `DeleteService` class with `can_delete`, `compute_consequences`, and `execute_deletion` methods
  ...
  - [x] 4.2 Write property test for main person guard (Property 5)
...
- [x] 5. Implement confirmation dialog UI
  - [x] 5.1 Implement `build_warning_lines` pure function and `DeletePersonDialog`
  ...
  - [x] 5.2 Write property test for warning list cap (Property 9)
  ...
  - [x] 5.3 Write unit tests for warning text formatting
...
- [x] 6. Wire delete action into existing UI
  - [x] 6.1 Integrate DeleteService and dialog into context menu and person editor
  ...
  - [x] 6.2 Write integration tests for end-to-end deletion flow
