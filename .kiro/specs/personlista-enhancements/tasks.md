...
- [ ] 1. Extend data model and display info construction
  - [ ] 1.1 Extend `PersonDisplayInfo` dataclass with new fields
  ...
  - [ ] 1.2 Update `build_person_display_list()` to populate new fields
...
- [ ] 2. Implement column visibility settings
  - [ ] 2.1 Create `ColumnVisibility` dataclass and extend `AppSettings`
  ...
  - [ ]* 2.2 Write property test for column visibility round-trip persistence
...
- [ ] 4. Implement name filtering across all name versions
  - [ ] 4.1 Update `filter_persons()` to support multi-name filtering
  ...
  - [ ] 4.2 Update `filter_persons()` to support cluster filter
  ...
  - [ ]* 4.3 Write property tests for name and cluster filtering
...
- [ ] 6. Implement column header and visibility UI
  - [ ] 6.1 Build column header widget for `PersonListPanel`
  ...
  - [ ] 6.2 Implement column header context menu for visibility toggling
...
- [ ] 7. Implement row rendering with new columns and indicators
  - [ ] 7.1 Implement ancestry/descendancy dot indicators in row widget
  ...
  - [ ] 7.2 Implement lineage computation and caching
  ...
  - [ ] 7.3 Implement DNA company icons in row widget
  ...
  - [ ] 7.4 Implement Titel, Yrke, Kluster columns in row widget
  ...
  - [ ] 7.5 Implement multiple names indicator
  ...
  - [ ]* 7.6 Write property test for multiple names tooltip format
