...
- [x] 1. Pure logic — Map data service
  - [x] 1.1 Implement map_data_service.py
  ...
  - [x] 1.2 Write property tests for map data service
...
- [x] 2. Checkpoint — Data service
  - Ensure all property tests and unit tests pass.

- [x] 3. UI components — Map dialog and bridge
  - [x] 3.1 Create map HTML template
  ...
  - [x] 3.2 Implement MapBridge (QWebChannel bridge)
...
- [x] 4. Checkpoint — Dialog renders
  - Verify that MapDialog can be instantiated and renders a map with test markers.

- [x] 5. Integration — Menus, context menu, and person editor
  - [x] 5.1 Create map marker SVG icon and add to IconRegistry
  ...
  - [x] 5.2 Enhance person editor events list with place name and map icon
  ...
  - [x] 5.3 Add "Visa på karta" to context menu
  ...
  - [x] 5.4 Add Karta menu to menu bar
  ...
  - [x] 5.5 Add "Visa på karta" button to Place Editor
  ...
  - [x] 5.6 Show map icon on places with coordinates in Place Editor list and parent combo
    - Modify `slaktbusken/ui/editors/place_editor.py`
  ...
  - [x] 5.7 Implement CoordinateSpinBox with paste support for period decimals
  ...
  - [x] 5.8 Implement app.py handler methods
