...
- [x] 1. Update PersonBoxConfig and card width constant
  - [x] 1.1 Add new config fields and update box width
  ...
  - [x] 1.2 Write unit tests for PersonBoxConfig new fields
...
- [x] 2. Implement multiple names indicator
  - [x] 2.1 Add multiple names icon to IconRegistry
  ...
  - [x] 2.2 Implement `_paint_multiple_names_icon` in PersonBoxItem
  ...
  - [x] 2.3 Write property test for multiple names indicator (Property 1)
  ...
  - [x] 2.4 Write property test for config-independence (Property 2)
...
- [x] 3. Implement main person orange border
  - [x] 3.1 Implement border color priority logic in PersonBoxItem
  ...
  - [x] 3.2 Write property test for border color precedence (Property 6)
...
- [x] 4. Implement profile photo display
  - [x] 4.1 Implement `_paint_profile_photo` in PersonBoxItem
  ...
  - [x] 4.2 Write property test for text x-offset (Property 7)
  ...
  - [x] 4.3 Write property test for photo scaling (Property 8)
...
- [x] 5. Checkpoint - Verify core visual elements
  - Ensure all tests pass, ask the user if questions arise.

- [x] 6. Implement birth/death place display
  - [x] 6.1 Add place line rendering in PersonBoxItem paint logic
  ...
  - [x] 6.2 Write property test for place line ordering (Property 9)
  ...
  - [x] 6.3 Write property test for place text truncation (Property 10)
...
- [x] 7. Implement cause of death display
  - [x] 7.1 Add cause of death line rendering in PersonBoxItem
  ...
  - [x] 7.2 Write property test for cause of death display and truncation (Property 11)
...
- [x] 8. Implement DNA company logos
  - [x] 8.1 Add DNA company logo loading to IconRegistry
  ...
  - [x] 8.2 Implement `_paint_dna_logos` in PersonBoxItem
  ...
  - [x] 8.3 Write property test for DNA logo count (Property 3)
  ...
  - [x] 8.4 Write property test for DNA logo ordering (Property 4)
  ...
  - [x] 8.5 Write property test for DNA text placeholder (Property 5)
...
- [x] 9. Implement cluster display
  - [x] 9.1 Implement `_paint_cluster_lines` in PersonBoxItem
  ...
  - [x] 9.2 Write property test for cluster sorting and cap (Property 12)
  ...
  - [x] 9.3 Write property test for cluster text color (Property 13)
  ...
  - [x] 9.4 Write property test for cluster overflow indicator (Property 14)
...
- [x] 10. Checkpoint - Verify all field rendering
  - Ensure all tests pass, ask the user if questions arise.

- [x] 11. Update view renderers to build extended display_data
  - [x] 11.1 Update FamilyView display_data construction
  ...
  - [x] 11.2 Update AncestryView display_data construction
    - Apply the same display_data extensions as FamilyView (same fields, same logic)
    - _Requirements: 1.1, 2.1, 3.1, 4.1, 5.1, 5.2, 6.1, 7.1, 8.4_

  - [x] 11.3 Update DescendantsView display_data construction
    - Apply the same display_data extensions as FamilyView (same fields, same logic)
    - _Requirements: 1.1, 2.1, 3.1, 4.1, 5.1, 5.2, 6.1, 7.1, 8.4_

  - [x] 11.4 Write integration tests for view renderer display_data
