...
- [x] 1. Create pure logic module for name resolution and match formatting
  - [x] 1.1 Create `slaktbusken/ui/dna_match_display.py` with `resolve_person_display_name` function
  ...
  - [x] 1.2 Add `format_match_entry` function to `slaktbusken/ui/dna_match_display.py`
  ...
  - [x] 1.3 Add `matches_filter` function to `slaktbusken/ui/dna_match_display.py`
  ...
  - [x] 1.4 Write property test for name resolution and format correctness
  ...
  - [x] 1.5 Write property test for filter correctness
...
- [x] 2. Checkpoint - Ensure pure logic tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [x] 3. Integrate filter widget and updated display into DnaEditor UI
  - [x] 3.1 Add `QLineEdit` filter widget to the matches tab UI
  ...
  - [x] 3.2 Modify `DnaEditor._refresh_matches_list` to use new formatting and filter
  ...
  - [x] 3.3 Connect filter signal and add refresh handler
  ...
  - [x] 3.4 Write property test for filter consistency after data change
  ...
  - [x] 3.5 Write property test for filter text preservation on refresh
  ...
  - [x] 3.6 Write unit tests for UI integration
