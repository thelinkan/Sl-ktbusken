...
- [x] 1. Data model extensions and project infrastructure
  - [x] 1.1 Extend DnaCompany, DnaProfile, and DnaMatch data models
  ...
  - [x] 1.2 Implement dna/ subfolder file management utilities
  ...
  - [x] 1.3 Write property tests for haplogroup preservation and max length enforcement
    - **Property 1: Haplogroup preservation across test type changes**
    - **Property 2: Haplogroup max length enforcement**
    - **Validates: Requirements 1.7, 1.8**

  - [x] 1.4 Write property test for segment data preservation round-trip
    - **Property 4: Segment data preservation round-trip**
    - **Validates: Requirements 5.3, 5.4**

- [x] 2. Pure logic modules — parsing and formatting
  - [x] 2.1 Implement relationship_lookup.py
  ...
  - [x] 2.2 Write property test for relationship probability consistency
    - **Property 6: Relationship probability consistency**
    - **Validates: Requirements 10.4, 10.6**

  - [x] 2.3 Implement dna_raw_parser.py
  ...
  - [x] 2.6 Write property tests for match CSV parsing
  ...
  - [x] 2.7 Implement chromosome_data.py
  ...
  - [x] 2.8 Write property test for chromosome segment calculations
    - **Property 13: Chromosome segment position and width calculation**
    - **Validates: Requirements 15.3, 15.5, 15.6**

  - [x] 2.9 Implement triangulation_format.py
  ...
  - [x] 2.10 Write property test for triangulation formatting
    - **Property 3: Triangulation format with unresolvable fallback**
    - **Validates: Requirements 2.1, 2.2**

  - [x] 2.11 Implement match segment serialization/deserialization
  ...
  - [x] 2.12 Write property test for match segment serialization round-trip
