...
- [ ] 1. Extend data model and create service-layer components
  - [ ] 1.1 Add `photo_date` and `notes` fields to MediaItem dataclass
  ...
  - [ ] 1.2 Create `PhotoDateValidator` service
  ...
  - [ ] 1.7 Write property test for event filtering by linked persons
    - **Property 4: Event filtering by linked persons**
    - **Validates: Requirements 7.4, 7.5**

  - [ ] 1.8 Write property test for tag add/remove preserves non-target entities
    - **Property 5: Tag add/remove preserves non-target linked entities**
    - **Validates: Requirements 7.6, 7.7, 8.4, 8.5**

  - [ ] 1.9 Write property test for place availability filtering
    - **Property 6: Place availability filtering excludes already linked**
    - **Validates: Requirements 8.3**

  - [ ] 1.10 Write property test for photos-for-entity filtering
    - **Property 7: Photos-for-entity filtering**
    - **Validates: Requirements 9.1**

- [ ] 2. Checkpoint - Ensure all service-layer tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 3. Build the EditPhotoDialog UI
  - [ ] 3.1 Create `EditPhotoDialog` skeleton with sections layout
  ...
  - [ ] 3.2 Implement "Titel och typ" section in EditPhotoDialog
  ...
  - [ ] 3.3 Implement "Fotodatum" section in EditPhotoDialog
  ...
  - [ ] 3.4 Implement "Personer på fotot" section in EditPhotoDialog
  ...
  - [ ] 3.5 Implement "Händelser" section in EditPhotoDialog
  ...
  - [ ] 3.6 Implement "Platser" section in EditPhotoDialog
  ...
  - [ ] 3.7 Implement "Anteckningar" section in EditPhotoDialog
  ...
  - [ ] 3.8 Implement save/cancel logic and validation flow in EditPhotoDialog
...
- [ ] 4. Checkpoint - Verify EditPhotoDialog functions correctly
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 5. Simplify FotoTab and wire to EditPhotoDialog
  - [ ] 5.1 Remove inline editing from FotoTab
  ...
  - [ ] 5.2 Add "Redigera foto" button and update FotoTab button layout
  ...
  - [ ] 5.3 Wire FotoTab buttons and double-click to EditPhotoDialog
  ...
  - [ ] 5.4 Write unit tests for FotoTab button states and layout
...
- [ ] 6. Build PhotoSectionWidget and integrate into PlaceEditor
  - [ ] 6.1 Create `PhotoSectionWidget` reusable widget
  ...
  - [ ] 6.2 Integrate PhotoSectionWidget into PlaceEditor
  ...
  - [ ] 6.3 Write property test for new photo creation with linked entity
    - **Property 8: New photo creation produces correct MediaItem and LinkedEntity**
    - **Validates: Requirements 9.6, 10.4**

- [ ] 7. Split EventEditor media into "Foton" and "Annan media"
  - [ ] 7.1 Replace single "Händelsemedia" section with two sections in EventEditor
  ...
  - [ ] 7.2 Write property test for non-photo media type invariant
