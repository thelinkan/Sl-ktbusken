...
- [x] 2. Implement validation logic for continent and country hierarchy
  - [x] 2.1 Extend `validate_place()` and `_validate_place_hierarchy()` in `slaktbusken/model/validators.py`
  ...
  - [x] 2.2 Write property test for continent hierarchy enforcement (Property 2)
  ...
  - [x] 2.3 Write property test for country parent must be continent (Property 3)
  ...
  - [x] 2.4 Write property test for universal types and locality (Property 8)
...
- [x] 3. Implement region level validation
  - [x] 3.1 Add `validate_region_levels()` function to `slaktbusken/model/validators.py`
  ...
  - [x] 3.2 Add `validate_custom_field_values()` function to `slaktbusken/model/validators.py`
  ...
  - [x] 3.3 Write property test for region level validation (Property 4)
  ...
  - [x] 3.4 Write property test for region levels ignored on non-country places (Property 5)
  ...
  - [x] 3.5 Write property test for custom field value length validation (Property 10)
  ...
  - [x] 3.6 Write property test for coordinates may be None (Property 9)
...
- [x] 4. Checkpoint - Ensure all model validation tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [x] 5. Update serialization for RegionLevel and CustomFieldDef
  - [x] 5.1 Register new nested types in `slaktbusken/persistence/serialization.py`
  ...
  - [x] 5.2 Write property test for serialization round-trip (Property 11)
...
- [x] 6. Create country presets module
  - [x] 6.1 Create `slaktbusken/data/country_presets.py`
  ...
  - [x] 6.2 Write unit tests for country presets
...
- [x] 7. Checkpoint - Ensure model and persistence tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [x] 8. Update Place Editor UI for new hierarchy
  - [x] 8.1 Implement `build_type_options()` in `slaktbusken/ui/editors/place_editor.py`
  ...
  - [x] 8.2 Write property test for type dropdown contents (Property 6)
  ...
  - [x] 8.3 Write property test for removing country removes exclusive labels (Property 7)
  ...
  - [x] 8.4 Add preset selection UI and custom field inputs in Place_Editor
...
- [x] 9. Wire integration and final validation
  - [x] 9.1 Update `conftest.py` Hypothesis strategies for new place types
  ...
  - [x] 9.2 Ensure PlaceRef allows continent and country references without restriction
  ...
  - [x] 9.3 Write integration tests for save/load cycle with hierarchy
