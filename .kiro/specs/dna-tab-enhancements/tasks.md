...
- [ ] 1. Add company logo icons to DNA profiles and matches lists
  - [ ] 1.1 Add icons to the DNA profiles list in PersonEditor
  ...
  - [ ] 1.2 Add icons to the DNA matches list in PersonEditor
  ...
  - [ ] 1.3 Write property tests for icon resolution (Properties 1 and 2)
...
- [ ] 2. Implement edit mode for DnaProfileDialog
  - [ ] 2.1 Add edit mode to DnaProfileDialog
  ...
  - [ ] 2.2 Add edit button and double-click handler for DNA profiles in PersonEditor
  ...
  - [ ] 2.3 Write property tests for profile edit (Properties 3–7 for profiles)
...
- [ ] 3. Implement edit mode for DnaMatchDialog with same-company filtering
  - [ ] 3.1 Add same-company profile filtering to DnaMatchDialog
  ...
  - [ ] 3.2 Add edit mode to DnaMatchDialog
  ...
  - [ ] 3.3 Add edit button and double-click handler for DNA matches in PersonEditor
  ...
  - [ ] 3.4 Write property tests for match edit and same-company filtering (Properties 3–8)
...
- [ ] 4. Checkpoint - Ensure profiles and matches edits work correctly
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 5. Implement triangulation section in DNA tab
  - [ ] 5.1 Add triangulation list and buttons to the DNA tab in PersonEditor
  ...
  - [ ] 5.2 Create DnaTriangulationDialog with person validation logic
  ...
  - [ ] 5.3 Wire triangulation add/edit in PersonEditor
  ...
  - [ ] 5.4 Write property tests for triangulation (Properties 9–14)
...
- [ ] 6. Move cluster section to its own tab
  - [ ] 6.1 Extract cluster widgets from DNA tab into a new Kluster tab
  ...
  - [ ] 6.2 Write unit tests for tab structure
