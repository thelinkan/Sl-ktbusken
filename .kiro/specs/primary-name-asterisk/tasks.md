...
- [ ] 2. Checkpoint - Ensure parser tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 3. Integrate name parser into Person Box rendering
  - [ ] 3.1 Update view layer `_build_display_data` to include parsed name
  ...
  - [ ] 3.2 Update `PersonBoxItem.paint()` in `slaktbusken/ui/widgets/person_box.py` to render tilltalsnamn with underline
  ...
  - [ ] 3.3 Write unit tests for Person Box tilltalsnamn rendering
